/* ==========================================================
   ...
   page, TikTok page, phone number), the dynamic brand name
...
router.post('/', requireAdmin, async (req, res) => {
  let { facebookUrl, tiktokUrl, phone, aboutText, brandName, heroTagline } = req.body;
  ...
  if (tiktokUrl && !/^https?:\/\//i.test(tiktokUrl)) tiktokUrl = 'https://' + tiktokUrl;

  try {
    await pool.query(
      `INSERT INTO site_settings (id, facebook_url, tiktok_url, phone, about_text, brand_name, hero_tagline)
       VALUES (1,$1,$2,$3,$4,$5,$6)
       ON CONFLICT (id) DO UPDATE SET facebook_url=$1, tiktok_url=$2, phone=$3, about_text=$4, brand_name=$5, hero_tagline=$6`,
      [facebookUrl || null, tiktokUrl || null, phone || null, aboutText || null, brandName || null, heroTagline || null]
    );
    res.json(serialize({
      facebook_url: facebookUrl, tiktok_url: tiktokUrl, phone, about_text: aboutText,
