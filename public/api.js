...
// ---------------- Coupons ----------------
async function apiValidateCoupon(code) { return apiCall('POST', '/api/coupons/validate', { code }); }
async function apiGetAutoCoupon(email) { return apiCall('GET', '/api/coupons/auto' + (email ? `?email=${encodeURIComponent(email)}` : '')); }
async function apiGetCouponBanner(email) { return apiCall('GET', '/api/coupons/banner' + (email ? `?email=${encodeURIComponent(email)}` : '')); }
async function getCoupons() { return apiCall('GET', '/api/coupons'); }
async function addCoupon(coupon) { return apiCall('POST', '/api/coupons', coupon); }
async function updateCoupon(id, coupon) { return apiCall('PUT', '/api/coupons/' + id, coupon); }
async function deleteCoupon(id) { return apiCall('DELETE', '/api/coupons/' + id); }
...
// ---------------- Media Library (item 12) ----------------
async function getMediaLibrary() { return apiCall('GET', '/api/media'); }
async function uploadMedia(item) { return apiCall('POST', '/api/media', item); }
async function deleteMedia(id, force) { return apiCall('DELETE', '/api/media/' + id + (force ? '?force=1' : '')); }

// ---------------- Announcement bar (item 11) ----------------
async function getAnnouncementBar() { return apiCall('GET', '/api/announcement'); }
async function saveAnnouncementBar(data) { return apiCall('POST', '/api/announcement', data); }
