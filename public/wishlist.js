...
async function render() {
  ...
  try {
    ...
    if (!items.length) {
      renderEmptyState('Nothing saved yet — tap the heart on any item in the shop to save it here.<br><a class="empty-state__btn" href="index.html#products" style="margin-top:0.6rem;">Shop now</a>');
      return;
    }
    emptyEl.style.display = 'none';
